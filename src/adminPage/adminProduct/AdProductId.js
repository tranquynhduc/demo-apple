import './AdProductId.css';
import SideBar from '../sidebar/SideBar';
import { Link } from "react-router-dom";
  import Chart from '../chart/Chart'; 
 import { ProductData } from '../../dummyData';  

export default function AdProductId() {
            ...
            <div className='product'>
                <div>
                    ...
                    <h1 className='productTitle'>Product</h1>
                            <Link to='/newProduct'>
                            <div> <button className='productAddButton'>Create</button></div>
                            </Link>
                    </div>
                    <div className='porudctTop'>
                        <div className='productLeft'>
                                <Chart data={ProductData} datakey='sales' title='sales Perfoce' />   
                        </div>
                        <div className='productRight'>
                            <div className='productInforTop'>
                                <img src='https://www.cnet.com/a/img/ndPmjg_XWB6TcyWibCelaHgm-7I=/940x0/2021/11/27/ec62e514-a658-4706-8623-edf4c407e0ab/apple-airpods-pro-red-background.png' className='productInforImg' alt='abc' />
                                <span className='productName'> Apple </span>
                            </div>
                            <div className='productInforBottom'></div>
                    ...
                    <div className='porudctBottom'>
                        <form className='productForm'>
                            ...
                            <div className='productUpload'>
                                <img src='https://www.cnet.com/a/img/ndPmjg_XWB6TcyWibCelaHgm-7I=/940x0/2021/11/27/ec62e514-a658-4706-8623-edf4c407e0ab/apple-airpods-pro-red-background.png' className='productUploadImg' alt='abc' />
                                <label for='file'>
                                <i class="fas fa-upload productUploadIcon"></i>
                                </label>
